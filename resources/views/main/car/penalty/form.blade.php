    ...
    <div class="box {{ CommonHelper::getBoxTheme() }}">
        ...
        <div class="box-body">
            <div class="form-group {{ $errors->has('car_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    {!! Form::select('car_id', $cars->pluck('id_number','id'), null, ['id'=>'car_id','class'=>'select2 form-control', 'placeholder'=> '--- Select Car ---']) !!}
            ...
            <div class="form-group {{ $errors->has('cost') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="cost" name="cost" value="{{ CommonHelper::getVal($model, 'cost') }}">
                    @if ($errors->has('cost'))
                        <span class="help-block">
