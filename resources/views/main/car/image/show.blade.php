        ...
        <div class="box-body">
            <form class="form-horizontal">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Car Number :</label>
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ CommonHelper::getVal($model->Car, 'id_number') }}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Preview :</label>
                    <div class="col-sm-3">
                        <img src="{{ url(CommonHelper::getVal($model, 'path')) }}" class="img-responsive img-thumbnail" alt="{{ CommonHelper::getVal($model->Product, 'name') }}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">
                            {!! (int) CommonHelper::getVal($model, 'is_primary') == 1 ? '<span class="label label-success"> Yes</span></td>' : '<span class="label label-danger"> No</span></td>' !!}
                        </p>
                    </div>
                </div>
            </form>
