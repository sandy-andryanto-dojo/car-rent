        ...
        <div class="box-body">
            <form class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ CommonHelper::getVal($model->Customer, 'name') }}</p>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">
                            <a class="btn btn-sm btn-success" target="_blank" href="{{ url(CommonHelper::getVal($model, 'path')) }}">
