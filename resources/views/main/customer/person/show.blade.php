        ...
        <div class="box-body">
            <form class="form-horizontal">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Customer Number :</label>
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ CommonHelper::getVal($model, 'code') }}</p>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Identity Type :</label>
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ CommonHelper::getVal($model->Identity, 'name') }}</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Customer Photo :</label>
                    <div class="col-sm-3">
                        <img src="{{ url(CommonHelper::getVal($model, 'image')) }}" class="img-responsive img-thumbnail" alt="{{ CommonHelper::getVal($model, 'name') }}">
                    </div>
                </div>
                @endif
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ (int) CommonHelper::getVal($model, 'gender') == 1 ? "Male" : "Female" }}</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p class ="form-control-static">{{ (int) CommonHelper::getVal($model, 'is_banned') == 1 ? "Active" : "Banned" }}</p>
                    </div>
                </div>
            </form>
        </div>
