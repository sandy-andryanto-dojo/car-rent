...
<section class="content">
    ...
    <div class="row" id="invoice-content">
        <div class="col-md-5">
            @include('main.transaction.order.form-product')
        </div>
        <div class="col-md-7">
            @include('main.transaction.order.form-billing')
        </div>
    </div>
...
@section('scripts')
<script src="{{ asset('assets/scripts/transaction.order.form.js') }}?{{ time() }}"></script>
@endsection